...
@Component({
  selector: 'app-employee-modal-register',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, EmployeeTableComponent, EmployeeFormComponent],
  templateUrl: './employee-modal-register.component.html',
  styleUrl: './employee-modal-register.component.css'
})
export class EmployeeModalRegisterComponent {
